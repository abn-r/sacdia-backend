...
ALTER TABLE material_categories ADD COLUMN local_field_id INT;
...
ALTER TABLE material_categories
  ...
  ADD CONSTRAINT uq_material_categories_local_field_slug UNIQUE (local_field_id, slug),
  ADD CONSTRAINT uq_material_categories_id_local_field UNIQUE (id, local_field_id);
...
CREATE INDEX idx_material_audit_lf_created
  ON material_audit_logs (local_field_id, created_at DESC);
CREATE INDEX idx_material_audit_entity_created
