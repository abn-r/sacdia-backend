...
export class CreateAchievementDto {
  ...
  @ApiPropertyOptional({
    description: 'Puntos que otorga el logro',
    default: 0,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'El logro puede obtenerse más de una vez',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description:
      'Número máximo de veces que se puede obtener (null = sin límite)',
  })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    description:
      'ID del tipo de club al que aplica (solo si scope = CLUB_TYPE)',
  })
  @IsOptional()
  @IsInt()
  club_type_id?: number;
  ...
  @ApiPropertyOptional({
    description: 'ID del logro que se requiere obtener antes de este',
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Clave del badge en R2 storage',
    maxLength: 500,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Estado activo del logro',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
