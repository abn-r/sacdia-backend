 ...
 * Returned by GET /receipts/:folio (list) and POST /approve, /reject.
...
/**
 * List response for GET /receipts/:folio.
 */
 ...
 * The `order` field carries the full OrderDto shape; typed as `object` to
 * avoid a circular import since OrderDto lives in the orders sub-module.
 */
