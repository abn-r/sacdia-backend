...
let PostRegistrationController = class PostRegistrationController {
    ...
    buildActorContext(userId, request) {
    ...
    async getStatus(userId, request) {
        return this.postRegistrationService.getStatus(userId, this.buildActorContext(userId, request));
    }
    async completeStep1(userId, request) {
        return this.postRegistrationService.completeStep1(userId, this.buildActorContext(userId, request));
    }
    async completeStep2(userId, request) {
        return this.postRegistrationService.completeStep2(userId, this.buildActorContext(userId, request));
    }
    async completeStep3(userId, dto, request) {
        return this.postRegistrationService.completeStep3(userId, dto, this.buildActorContext(userId, request));
    }
};
exports.PostRegistrationController = PostRegistrationController;
__decorate([
    (0, common_1.Get)('status'),
    (0, decorators_1.SensitiveUserSubresource)('post_registration', 'read'),
...
__decorate([
    ...
    (0, decorators_1.SensitiveUserSubresource)('post_registration', 'update'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, complete_club_selection_dto_1.CompleteClubSelectionDto, Object]),
    __metadata("design:returntype", Promise)
